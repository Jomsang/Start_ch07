...
public class Example {
	...
	public static void method(RemoteControl rc) {	//오로지 인터페이스만 존재(객체가 없음) //이 인터페이스로 사용 가능한 객체만 매개변수로 올 수 있음
	...
	public static void main(String[] args) {
		...
		//method(rc1);
		method(new Television());//다형성이 나타남, 텔레비전을 넣으면 텔레비전 메소드들이 실행, 오디오를 넣으면 오디오 메소드들 실행
		method(new Audio());
	}
